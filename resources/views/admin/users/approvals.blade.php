    ...
    <div class="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl px-5 py-4">
            ...
            <p class="text-xs text-amber-700 leading-relaxed">
                <strong>Al aprobar un colaborador</strong> se genera automáticamente un par de llaves RSA-2048.
                La llave privada se muestra <strong>una sola vez</strong> — entréguela al colaborador de inmediato.
